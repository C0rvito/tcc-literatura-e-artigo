...
## Mapeamento de Interações (Rede)
- **[[RHOT1]] (MIRO1) <-> TUBA1A**: Miro1 ancora as mitocôndrias aos microtúbulos via proteínas motoras. Mutações desregulam fisicamente essa interação, causando disfunção de transporte de ATP nas neurites.
- **Sinalização ROBO -> TUBA1A**: Vias guiadas por SLIT/ROBO impactam diretamente a polimerização dos microtúbulos.

## Alvos Fármaco-Rede
O PD-KG relacionou distúrbios na tubulina a drogas reaproveitáveis que têm o citoesqueleto como alvo (ex: Docetaxel, um antineoplásico estabilizador de microtúbulos) [[Zagare-et-al-2025]].
